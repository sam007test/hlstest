...
# Create a specific temp directory for streams
UPLOAD_FOLDER = os.path.join(tempfile.gettempdir(), 'stream_temp')
       ...
       def process_video():
           try:
               ...
               ffmpeg_cmd = [
                   ...
                   "-hls_segment_filename", os.path.join(UPLOAD_FOLDER, "segment%03d.ts"),
                   "-f", "hls",
                   os.path.join(UPLOAD_FOLDER, "stream.m3u8"),
               ]
